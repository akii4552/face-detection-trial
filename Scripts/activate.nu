...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\akash_programs\face_recognization_using_flask\rough\rough'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\akash_programs\face_recognization_using_flask\rough\rough\Scripts\deactivate.nu'
